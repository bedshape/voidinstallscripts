...
# Prompt for the amount of swap in GB
read -p "Enter the amount of swap in GB: " swap_size
...
lvcreate -L ${swap_size}G -n swap vols && mkswap /dev/vols/swap || handle_error
